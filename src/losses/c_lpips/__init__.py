...
from ..c_lpips import dist_model
...
class PerceptualLoss(torch.nn.Module):
    ...
    def forward(self, pred, target, mask=None, normalize=False,retPerLayer=False):
        """
        ...
        return self.model.forward(target, pred, mask=mask, retPerLayer=retPerLayer)
